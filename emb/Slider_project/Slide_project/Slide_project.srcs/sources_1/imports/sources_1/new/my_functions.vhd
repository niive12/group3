...
package body my_functions is
    ...
    function minimum( a, b, c, d : integer ) return std_logic_vector is
        variable result : std_logic_vector(1 downto 0) := "00";
        variable minima : integer range 0 to 512 := 512;
        begin
            if a < minima then
                minima := a;
                result := "00";
    ...
    function maximum( a, b, c, d : integer ) return std_logic_vector is
        variable result : std_logic_vector(2 downto 0) := "000";
        variable maxima : integer range 0 to 1536 := 0;
        begin
            if a > maxima then
                maxima := a;
                result := "001";
